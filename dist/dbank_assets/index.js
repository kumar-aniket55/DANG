...
/* harmony import */ var _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/dbank */ "./src/declarations/dbank/index.js");
 ...
 window.addEventListener("load",async ()=>{
    var currentBalance = await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.checkBalance();
...
document.querySelector("form").addEventListener("submit",  async (event)=>{
    ...
    if(credit!="")
    {
        await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.topUp(parseFloat(credit));
    }
    if(debit!="")
    {
        await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.withdraw(parseFloat(debit));
    }
    var currentBalance = await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.checkBalance();
    document.querySelector("#value").innerHTML=currentBalance.toFixed(2);
